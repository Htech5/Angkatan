<nav class="sticky z-50">
    <div class="max-w-full px-2 sm:px-6 lg:px-8 bg-mocca items-center fixed top-0 left-0 w-full shadow-md p-4 z-10 drop-shadow-xl">
        ...
        <div class="flex items-center justify-between h-10">
            ...
            <div class="w-6 p-2 mr-2 text-white hidden" id="closenav">
                <div id="close" class="transition-all duration-300 rotate-45">&#128936;</div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            opennavBtn.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    closeBtn.classList.add('opacity-100','rotate-180');
                    closeBtn.classList.remove('opacity-0','rotate-45');
                    opennavBtn.classList.remove('rotate-180');
                }, 10); 
            });
            ...
            closenavBtn.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    closeBtn.classList.remove('opacity-100','rotate-180');
                    closeBtn.classList.add('opacity-0','rotate-45');
                    opennavBtn.classList.add('rotate-180');
